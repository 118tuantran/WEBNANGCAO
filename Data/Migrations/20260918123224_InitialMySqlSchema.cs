    ...
    public partial class InitialMySqlSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Reason = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IsAdjusted = table.Column<bool>(type: "tinyint(1)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, true, "Thiết bị máy tính" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "WH-MAIN", true, "Kho chính" });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "IsActive", "Name", "Sku", "Unit" },
                values: new object[,]
                {
                    { 1, 1, true, "Bàn phím cơ", "SKU-001", "cái" },
                    { 2, 1, true, "Chuột không dây", "SKU-002", "cái" }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "IsActive", "PasswordHash", "Role", "RoleId", "Username" },
                values: new object[,]
                {
                    { 1, true, "E86F78A8A3CAF0B60D8E74E5942AA6D86DC150CD3C03338AEF25B7D2D7E3ACC7", 0, 1, "admin" },
                    { 2, true, "E8392925A98C9C22795D1FC5D0DFEE5B9A6943F6B768EC5A2A0C077E5ED119CF", 1, 2, "manager" },
                    { 3, true, "DFD48F36338AA36228EBB9E204BBA6B4E18DB0B623E25C458901EDC831FB18E9", 2, 3, "staff" }
                });

            migrationBuilder.InsertData(
                table: "Inventories",
                columns: new[] { "Id", "MinStock", "ProductId", "Quantity", "WarehouseId" },
                values: new object[,]
                {
                    { 1, 5, 1, 20, 1 },
                    { 2, 10, 2, 8, 1 }
